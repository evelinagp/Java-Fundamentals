...
public class NeedForSpeed3Exam02Ex31Map {
    public static void main(String[] args) {
        ...
        Map<String, List<Integer>> listCar = new HashMap<>();
...
//                    List<Integer> dataCar = listCar.get(car);
                    int distanceReal = listCar.get(car).get(0);
                    int fuelReal = listCar.get(car).get(1);
        ...
        listCar
                ...
                .forEach(e -> System.out.printf("%s -> Mileage: %d kms, Fuel in the tank: %d lt.%n", e.getKey(), e.getValue().get(0),
                        e.getValue().get(1)));
    }
}